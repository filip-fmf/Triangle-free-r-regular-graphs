...
\subsubsection*{Ugotovitve}
Rezultati kažejo, da je ta pogoj precej pogostejši kot pogoj $(i)$. Poleg visoko simetričnih grafov, kot sta Petersenov graf in popolni dvodelni graf $K_{r,r}$ z lihim $r$, obstajajo tudi drugi grafi, ki zadostijo temu pogoju. Pogoj $(ii)$ je zato veliko bolj vključujoč in se pojavlja v raznolikih strukturah, ki omogočajo, da se z vidika vsaj enega vozlišča identificira maksimalna močno liha neodvisna množica.

\begin{figure}[H]
\centering
\includegraphics[width=0.48\textwidth]{graph_n6_idx1.png}
\includegraphics[width=0.48\textwidth]{graph_n10_idx5.png}
\includegraphics[width=0.48\textwidth]{graph_n10_idx6.png}
\caption{Graf, ki ustreza $(ii)$ za $r=3$}
\end{figure}


\begin{figure}[H]
\centering
\includegraphics[width=0.20\textwidth]{graph_r5_n10_idx1.png}
\includegraphics[width=0.20\textwidth]{graph_r5_n16_idx179.png}
\includegraphics[width=0.20\textwidth]{graph_r5_n16_idx180.png}
\includegraphics[width=0.20\textwidth]{graph_r5_n16_idx181.png}
\includegraphics[width=0.20\textwidth]{graph_r5_n16_idx181.png}
\includegraphics[width=0.20\textwidth]{graph_r5_n16_idx372.png}
\includegraphics[width=0.20\textwidth]{graph_r5_n16_idx379.png}
\includegraphics[width=0.20\textwidth]{graph_r5_n16_idx383.png}
\caption{Grafi, ki ustrezajo ii) za $r=5$ pri različnih $n$}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.30\textwidth]{graph_r7_n14_idx1.png}
